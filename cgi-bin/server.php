...
//   $retVal .= "addKeywordMemberData(tx, keywordmembers);\n";
  ...
  $sql = "update user set uuid = '$uuid', platform = '$platform', lastupdate = now() where uuid = '$uuid'";
  mysql_query($sql);
  //print "console.log('retrieved new items');";
}
else {
...
//   $retVal .= "];\n";
//   $retVal .= "addKeywordMemberData(tx, keywordmembers);\n";
  //print "console.log('retrieved all items');";
}
