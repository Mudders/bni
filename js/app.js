...
var myApp = angular.module('myApp', ['myApp.filters', 'myApp.services', 'myApp.directives','ajoslin.mobile-navigate','ngMobile'])
    ...
    .config(['$routeProvider', function($routeProvider) {
        ...
        $routeProvider.when('/view1', {templateUrl: 'partials/chaptersView.html', controller: 'ChaptersCtrl'});
        $routeProvider.when('/view2', {templateUrl: 'partials/searchByIndustryView.html', controller: 'SearchIndustryCtrl'});
        ...
        $routeProvider.when('/view6/:id', {templateUrl: 'partials/membersByIndustryView.html', controller: 'MembersByIndustryCtrl'});
